  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-[radial-gradient(circle_at_top,_rgba(233,64,87,0.12),_transparent_28%),radial-gradient(circle_at_bottom_right,_rgba(15,118,110,0.08),_transparent_24%),linear-gradient(180deg,_#fffdfb_0%,_#f8fafc_100%)] px-4 py-6 sm:px-6 lg:px-8">
      ...
      <Link
        ...
        className="absolute left-4 top-4 z-20 inline-flex h-11 w-11 items-center justify-center rounded-full bg-white text-slate-800 shadow-[0_10px_30px_-18px_rgba(15,23,42,0.5)] ring-1 ring-slate-200 transition hover:-translate-y-0.5 hover:bg-slate-50 sm:left-6 sm:top-6 lg:left-8 lg:top-8"
        href="/"
      >
