...
export function LikesPageClient({ likedProfiles, errorMessage }: LikesPageClientProps) {
  ...
  return (
    <section className="min-h-[calc(100dvh-4rem)] rounded-[2rem] border border-white/10 bg-gradient-to-b from-[#090909] via-[#060606] to-[#030303] px-4 py-5 text-white shadow-[0_24px_90px_rgba(0,0,0,0.35)] md:px-6 md:py-6">
